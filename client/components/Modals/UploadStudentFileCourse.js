...
const UploadStudentFileCourse = ({
    ...
    const importStudents = async () => {
        try {
            setLoading(true);
            const response = await axios.post(`${process.env.NEXT_PUBLIC_API}/import-students/${id}`, { students });
...
export default UploadStudentFileCourse;
