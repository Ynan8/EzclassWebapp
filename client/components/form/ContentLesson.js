...
import { BsBlockquoteRight, BsFileEarmarkTextFill, BsQuestionSquare, BsThreeDots, BsThreeDotsVertical, BsYoutube } from 'react-icons/bs'
    ...
    return (
        ...
        >
                            ...
                            <div className="rounded-md shadow-md border border-opacity-50">
                                ...
                                <div className="px-8 pt-4 pb-6 space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        {lesson.answers && lesson.answers.map((answer, answerIndex) => (
            ...
            <div className="flex justify-center mt-6">
                <Button
                    size='lg'
                    onClick={handleAddContentLesson}
                    color="primary"
