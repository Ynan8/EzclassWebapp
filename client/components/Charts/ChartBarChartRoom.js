    ...
    const chart = new Chart(ctx, {
      ...
      //  labels: ["บทที่ที่ 1","บทที่ที่ 2","บทที่ที่ 3","บทที่ที่ 4","บทที่ที่ 5","บทที่ที่ 6","บทที่ที่ 7","บทที่ที่ 8","บทที่ที่ 9","บทที่ที่ 10","บทที่ที่ 11","บทที่ที่ 12","บทที่ที่ 13","บทที่ที่ 14"], "ชั้นม.5/1","ชั้นม.5/2","ชั้นม.5/3","ชั้นม.5/4","ชั้นม.5/5","ชั้นม.6/1","ชั้นม.6/2","ชั้นม.6/3","ชั้นม.6/4"
        datasets: [
          ...
          {
            label: "บทที่5",
            backgroundColor: "rgba(93, 109, 126 , 0.5)",
          ...
          {
            label: "บทที่6",
            backgroundColor: "rgba(175, 122, 197, 0.5)",
          ...
          {
            label: "บทที่7",
            backgroundColor: "rgba(19, 141, 117  , 0.5)",
          ...
          {
            label: "บทที่8",
            backgroundColor: "rgba(186, 74, 0, 0.5)",
        ...
        <div className="rounded-t mb-0 px-4 py-3 bg-transparent">
          <div className="flex flex-wrap items-center justify-between">
            <div className="relative">
              <h2 className="text-back text-xl font-semibold">คะแนนเฉลี่ยแบบทดสอบ จำแนกตามรายวิชา</h2>
            </div>
